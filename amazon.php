...
$sql = "SELECT id, Fullname, package, post FROM share WHERE company='Amazon'";
...
<div class="p">
<img src="https://www.doorwaysva.org/wp-content/uploads/2019/06/amazon-logo.png" width="200" height="150"><br>

<h3>Amazon Foundation:-</h3>
<p >When Amazon was founded on July 5, 1994, as a website that only sold books, founder Jeff Bezos had a vision for the company's explosive growth and ecommerce domination. He knew from the very beginning that he wanted Amazon to be "an everything store."</p>

<h3>Details:-</h3>
<p>Amazon.com is a vast Internet-based enterprise that sells books, music, movies, housewares, electronics, toys, and many other goods, either directly or as the middleman between other retailers and Amazon.com’s millions of customers. Its Web services business includes renting data storage and computing resources, so-called “cloud computing,” over the Internet.</p>

<h3>Headquarters:-</h3>
<p> The company is headquartered in Seattle, Washington, United States.</p>
